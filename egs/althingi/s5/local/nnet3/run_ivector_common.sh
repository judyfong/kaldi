...
if [ $stage -le 5 ]; then
  ...
  steps/align_fmllr.sh --nj 40 --cmd "$train_cmd" \
    data/${train_set}_sp_35k data/lang exp/tri3 exp/tri3_ali_sp_35k
fi
...
if [ $stage -le 6 ]; then
  ...
  if [ -e exp/nnet3${nnet3_affix}/tri4/final.mdl ]; then
  ...
  steps/train_lda_mllt.sh --cmd "$train_cmd" --num-iters 13 \
    ...
    exp/tri3_ali_sp_35k exp/nnet3${nnet3_affix}/tri4
fi
...
if [ $stage -le 7 ]; then
  ...
  steps/online/nnet2/train_diag_ubm.sh --cmd "$train_cmd" --nj 30 \
    ...
    exp/nnet3${nnet3_affix}/tri4 exp/nnet3${nnet3_affix}/diag_ubm
fi
...
if [ $stage -le 8 ]; then
  ...
  steps/online/nnet2/train_ivector_extractor.sh --cmd "$train_cmd" --nj 10 \
    data/${train_set}_sp_hires_70k exp/nnet3${nnet3_affix}/diag_ubm exp/nnet3${nnet3_affix}/extractor || exit 1;
fi
