...
python punctuator/local/extract_silence.py exp/reseg_fmllr_ali/merged_ctm_all_sym_edited_cut.txt exp/reseg_fmllr_ali/sil_all.txt &
...
python punctuator/local/add_sil_to_segm.py exp/reseg_fmllr_ali/text_newdata.txt exp/reseg_fmllr_ali/sil_newdata.txt exp/reseg_fmllr_ali/pause_annotated_text_newdata.txt
...
for speech in $(cat ${dir}/althingi.train_Sept2017_pause_simpleExp.txt); do
    ...
    python punctuator/local/segment_matching.py "$speech" ${dir}/segments.tmp ${dir}/althingi.train_Sept2017_pause_punct.txt 
